if status is-interactive
    ...
    alias anime="cd /media-pool/anime/"
    alias audiobooks="cd /media-pool/audiobooks"
    alias books="cd /media-pool/books"
    alias cl="/home/loon/bin/cleanup.sh"
    alias cla="tv; cl; anime; cl; cd ~"
